...
**Tabs** at the top let you switch between multiple open patterns.

**Canvas** displays your pattern on a grid where you can add and remove stitches.
Pan by dragging and zoom using your mouse wheel or touchpad gestures.

**Drawing Tools** are available in the palette panel's header.
These tools let you draw different types of stitches and manipulate the canvas.
...
- **Layers** button to toggle visibility of different pattern elements
- **Display mode** switcher to view your pattern as a mix, solid colors, or realistic stitches
- **Symbols toggle** to show or hide stitch symbols on the canvas
