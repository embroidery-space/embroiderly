...
Embroiderly can transform any photo or graphic into a cross-stitch pattern by analyzing the colors and mapping them to thread colors from the chosen palette.

## Opening the Image Import Windows
...
- the number of colors in the pattern, and
...
You can adjust these values to make your pattern larger (more detailed, longer stitching time) or smaller (less detailed, quicker to stitch).
...
> You can use up to 256 colors from the selected palette, though patterns with that many colors are extremely time-consuming to complete.
...
This parameter controls how thoroughly Embroiderly analyzes the image's colors during the quantization process.
...
Once you're satisfied with the preview, click the **Import Image** button at the bottom of the Image Import window.

Embroiderly creates a new pattern from your image and opens it in the pattern editor.
You can now edit it like any other pattern---add or remove stitches, edit the palette, adjust the fabric properties, and more.
