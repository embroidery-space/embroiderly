---
description: Complete reference of keyboard shortcuts available in Embroiderly
head:
  - - meta
    - name: keywords
      content: embroiderly shortcuts, keyboard shortcuts, hotkeys, cross-stitch shortcuts
---
...
Key combinations are processed immediately when all keys are pressed together.
...
- `P` - Petite Stitch (auto-positioned)
...
- `H` - Half Stitch (auto-positioned)
- `H-F` - Forward Half Stitch
- `H-B` - Backward Half Stitch

### Quarter Stitch

- `Q` - Quarter Stitch (auto-positioned)
