...
export const ToolSelectTheme = tv({
  slots: {
    ...
    mainButton:
      "inline-flex items-center justify-center rounded-md text-dimmed transition-colors not-disabled:hover:cursor-pointer not-disabled:hover:bg-elevated focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverted not-disabled:active:bg-elevated",
    mainButtonIcon: "shrink-0",
    dropdownButton: "absolute right-0 bottom-0 rounded-sm border-none p-0 not-disabled:hover:cursor-pointer",
  ...
  variants: {
    ...
    selected: {
      true: {
        mainButton: "bg-elevated hover:bg-accented",
      },
    },
    disabled: {
      true: {
